...
public class DefectEssence extends CustomRelic implements StartActSubscriber {

    /*
     * Add blue cards to the pool
     */

    // ID, images, text.
    public static final String ID = jesterMod.makeID("DefectEssence");
    ...
    public void addToPool(){
        ArrayList<AbstractCard> tmpPool = CardLibrary.getCardList(CardLibrary.LibraryType.BLUE);
