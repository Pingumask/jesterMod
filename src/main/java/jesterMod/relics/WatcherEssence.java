...
public class WatcherEssence extends CustomRelic implements StartActSubscriber {

    /*
     * Add purple cards to the pool
     */

    // ID, images, text.
    public static final String ID = jesterMod.makeID("WatcherEssence");
    ...
    public void addToPool(){
        ArrayList<AbstractCard> tmpPool = CardLibrary.getCardList(CardLibrary.LibraryType.PURPLE);
