...
public class SilentEssence extends CustomRelic implements StartActSubscriber {

    /*
     * Add green cards to the pool
     */

    // ID, images, text.
    public static final String ID = jesterMod.makeID("SilentEssence");
    ...
    public void addToPool(){
        ArrayList<AbstractCard> tmpPool = CardLibrary.getCardList(CardLibrary.LibraryType.GREEN);
